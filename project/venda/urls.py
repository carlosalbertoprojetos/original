...
urlpatterns = [
    ...
    path("select/meses/", v.meses_ajax, name="meses_ajax"),
    # path("select/anos/", v.anos_ajax, name="anos_ajax"),
    ...
    path("<hash>/orcamento/<int:id>/", v.orcamento, name="orcamento"),
    ...
    path(
        "<transportadora>/check/transporte/",
        v.listaConferenciaTransporteExpedicao,
        name="listaConferenciaTransporteExpedicao",
    ),
    path("<venda>/<cotacao>/deletar/cotacao/", v.deletarCotacao, name="deletarCotacao"),
]
