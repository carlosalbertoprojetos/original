...
def pega_dados_vhz(numero_nf, cnpj='51905769000190'):
    try:
        #lista_ocorrencias = ['Entrega Realizada', 'Carta de mercadoria à disposição enviada', 'Ocorrência de entrega']
        situacao = ''
        url = "http://www.vhztransporte.com.br/rastreamento.php"
...
#print(pega_dados_vhz(numero_nf=600))